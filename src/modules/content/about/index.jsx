...
export default function About() {
	return (
		<div className='about_container content_container'>
			...
			></List>
			<div className='about_transport'>Our transportation vehicles</div>
			<Transports />
			<div className='about_text'>
			...
			<div className='about_text'>
				...
				cultural assistance, will take care of your time management and
				logistics. For more information contact our team member by phone
				or by our web site:
				<a className='about_link' href='http://www.tilsimat-alemi.com'>
					{' '}
					tilsimat-alemi.com
				</a>
			</div>
			<div className='about_text'>
				You'll be pleasantly surprised by the quality of our service. We
				look forward to joint cooperation in the field of tourism.
			</div>
		</div>
	)
}
