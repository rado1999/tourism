	...
	return (
		<div className='destination_container'>
			...
			<div className='destination_card_container'>
				<div
					className='destination_card dc1'
					style={{ width: size[1].lg }}
					onMouseMove={() => slide(first)}
				>
					<div
						className='destination_card_image'
						style={{
							backgroundImage: `url('/places/abu-sagyt/6.webp')`,
						}}
					></div>
					<div
						className='destination_card_title'
				...
				<div
					className='destination_card dc2'
				...
				<div
					className='destination_card dc3'
				...
				<div
					className='destination_card dc4'
			...
			<div
				className='destination_view_all'
