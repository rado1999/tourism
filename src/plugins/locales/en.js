export const en = {
	...
	about: {
		back_title: 'About Us',
		title: '«TA Travel» TOURS ALONG THE GREAT SILK ROAD',
		text1: `The purpose and objective of the touristic company "TA
		...
		text2: `«TA Travel» offers you the following services`,
		services: {
			1: 'Letter Of Invitation (LOI)- Visa support for tourists to enter Turkmenistan',
			2: 'Provide a full package of tourist services for tourists to Turkmenistan (transfer, hotel reservation and accommodation of tourists in hotels, meals, excursions, tour routes for Turkmenistan)',
			3: 'Organization of pilgrimage and study tours with an experienced guide - interpreter',
			4: 'Hotel booking in Turkmenistan and abroad',
			5: 'Air tickets booking',
			6: 'Sales and booking air tickets',
			7: 'Guided tours to various countries of Turkmenistan',
			8: 'Transportation services',
			9: 'Business Tourism',
			10: 'Business Consultations',
			11: 'Organization of meetings, conferences',
			12: 'Taking part in various exhibitions',
			13: 'Servicing business delegations',
		},
		text3: `Specificity of the national culture of Turkmenistan is
		...
		tourists.`,
		text4: `TA Travel will provide you with professional language and
		...
		text5: `You'll be pleasantly surprised by the quality of our
		service. We look forward to joint cooperation in the field
		of tourism.`,
	},
	visa: {
		title: 'Visa',
		text1: `To obtain the tourist visa, all foreign nationals need a
		...
		text2: `Information we need for filing documents for the invitation`,
		documents: {
			1: 'Name and second name',
			2: 'Date of birth',
			3: 'Sex',
			4: 'Nationality',
			5: 'The color copy of your passport. The expiry date of the passport must be at least 6 months from the date of entry to Turkmenistan',
			6: '1 photo 5x6 sized (must be color)',
			7: 'Route (city) and accommodation (hotel)',
			8: 'The date of entry, exit (depending on the type of the required visa)',
			9: 'Home address and telephone number',
			10: 'Education level (name of the university and faculity)',
			11: 'Place of work, position and telephone number',
			12: 'The Embassy /Consulate the request to be send to (country, city)',
			13: 'The country from which the foreigner entries',
			14: 'Next country of destination after Turkmenistan',
		},
		warning: `We are not responsible for the untimely issuance of visas to
