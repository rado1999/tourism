export const jp = {
	...
	hotels: {
		...
		awaza: {
			title: `阿波座`,
			text: `2007年5月、トルクメニスタン大統領はトルクメンバシ市での首脳会議で、生態学的にきれいなカスピ海の海岸に世界クラスのリゾートを建設するというアイデアを思いついた。 これに先立ち、カスピ海沿岸では約３０００戸の民家が取り壊された。
			サミットから 2 か月後の 2007 年 7 月 21 日、カスピ海沿岸のセルダル ホテルで、将来の海辺リゾートの最初のプレゼンテーションが行われ、数十の外資系建設会社や投資会社が参加しました。
