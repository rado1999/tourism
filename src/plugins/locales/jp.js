export const jp = {
	...
	destinations: {
		abiverd: { title: 'アバード', text: `` },
		sagyt: { title: 'アブ・サジット', text: `` },
		horses: { title: 'アハルテケの馬', text: `` },
		alabay: { title: 'アラバイ', text: `` },
		arslan: { title: 'イル・アルスラーン', text: `` },
		ashgabat: { title: 'アシガバート', text: `` },
		astana: { title: 'アスタナ・ババ', text: `` },
		balkan: { title: 'バルカナバート記念碑', text: `` },
		camels: { title: 'ラクダ', text: `` },
		darvaza: { title: 'ダルワザ', text: `` },
		dehistan: { title: 'デヒスタン', text: `` },
		urgenc: { title: 'コネ・ウルゲンチ', text: `` },
		dino: { title: '恐竜の足跡', text: `` },
		gyzgala: { title: 'ギズ・ガラ', text: `` },
		zeyd: { title: 'イブン・ゼイド', text: `` },
		margush: { title: 'マーグシュ', text: `` },
		merv: { title: 'メルブ', text: `` },
		nohur: { title: 'ヌール村', text: `` },
		sanjar: { title: 'ソルタン・サンジャール', text: `` },
		torebeg: { title: 'トーレベグ・ハニム', text: `` },
		yangigala: { title: 'ヤンギガラ', text: `` },
		mosque: { title: 'トルクメンバシ モスク', text: `` },
		awaza: {
			title: '阿波座',
			text: `2007 年 5 月、トルクメニスタン大統領はトルクメンバシ市での首脳会議で、生態学的にきれいなカスピ海の海岸に世界クラスのリゾートを建設するというアイデアを思いつきました。 これに先立ち、カスピ海沿岸では約３０００戸の民家が取り壊された。
			サミットから 2 か月後の 2007 年 7 月 21 日、カスピ海沿岸のセルダル ホテルで、将来の海辺リゾートの最初のプレゼンテーションが開催され、数十の外資系建設会社や投資会社が参加しました。
			夏の間、アバザにはトルクメニスタン全土および海外からの観光客が訪れます。 アバザで同時に休暇を過ごす人の数は約4,000人です。 現在、このリゾートは、60の計画のうち17のホテル、6つのコテージ複合施設、7つのヘルスセンター、2つのヨットクラブのほか、長さ7キロメートルのコンクリートで固められた航行可能な川沿いに多数のレストランやカフェを建設している。 新しい保養地、家族旅行用のコテージ、豪華なヴィラ、スポーツとエンターテイメントの複合施設が建設されています。
			州レベルでは、エンターテイメントセンター、海洋水族館、ミニモータースポーツ用のカートセンター、ゴルフセンター、ショップ、サイクリングコース、イルカ水族館、プラネタリウム、映画館、劇場を備えたウォーターパークを建設することが決定されている。 アバザの海辺にある遊園地。
			観光客は、その優れたインフラストラクチャによっても Avaza に魅了されます。 トルクメンバシ市の近くには、トルクメンバシ国際空港のターミナル、トルクメンバシ国際空港、トルクメンバシ旅客鉄道駅があります。`,
		},
	},
	hotels: {
		charlak: {
		...
		garagum: {
			title: 'ガラガム',
			text: `ガラガム プロジェクトは、2018 年 9 月にトルクメニスタンのアシガバートで、この地域初の多目的ホテルおよびビジネスセンターとして立ち上げられました。
			プロジェクトのデザイナーは、世界最大の給水用水路の 1 つであるカラクム運河が通る、地球上最大の砂漠の 1 つであるカラクム砂漠にインスピレーションを得ました。ホテルはアシガバート国際空港のすぐ近くにあり、わずか 10 km の距離にあります。 市内中心部から。 ガラガムホテルの建築面積は68,900平方メートル、屋内面積は28,573平方メートルで、テクニカルフロアを含む8階建てです。ホテルにはファミリースイート8室、スタンダードルーム17室、デラックスルーム47室、スーパーデラックスルーム15室の計87室があり、 ベッド数102。 建築、豪華さ、ロケーションのおかげで、この地域で「最も特別な」プロジェクトの 1 つとして知られるガラガム ホテルには、ショッピング モール、150 席のレストラン、会議室、スパ、ジムも備えています。`,
		},
	},
	tours: {
		desert_8_days: {
